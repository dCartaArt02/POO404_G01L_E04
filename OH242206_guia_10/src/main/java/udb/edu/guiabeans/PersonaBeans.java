...
public class PersonaBeans {
    ...
    public List<PersonaBeans> getListaPersonas() {
        return listaPersonas;
    }

    public void setListaPersonas(List<PersonaBeans> listaPersonas) {
    ...
    private List<PersonaBeans> listaPersonas;
    public String PersonaBeans() {
        try {
            Class.forName("com.mysql.jdbc.Driver");
            conexion = DriverManager.getConnection("jdbc:mysql://localhost/personabddg8", "root", "Carta.345617");
        ...
        public List<PersonaBeans> getListaPersonas()  {
            try {
                ...
                rs = st.executeQuery();
                List<PersonaBeans> list = new ArrayList<>();
                while (rs.next()) {
