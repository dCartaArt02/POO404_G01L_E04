...
%>
        <tr>
            ...
            <td><button class="btn btn-info"
                        onclick="modificar('<%=rs.getString("id_persona")%>','<%=rs.getString("nombre_person
a")%>','<%=rs.getString("edad_persona")%>','<%=rs.getString("sexo_persona")%>','<%=
rs.getString("id_ocupacion")%>','<%=rs.getString("fecha_nac")%>','<%=rs.getString("usu
ario")%>')" >Modificar</button></td>
        </tr>
            <%
                }
                conexion.close();
