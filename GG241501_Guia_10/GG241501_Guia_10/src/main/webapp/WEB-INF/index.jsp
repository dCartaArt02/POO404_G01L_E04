<%@ page import="com.example.Bean1.PersonitaBean" %>
<jsp:useBean id="personalist" class="com.example.Bean1.PersonitaBean"
             scope="request"/>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <div>
        <div class="">
            <table class="table table-striped table-hover table-dark">
                ...
                <tbody>
                <% for (PersonitaBean persona: personalist.getListaPersonas() ) {%>
                <tr>
